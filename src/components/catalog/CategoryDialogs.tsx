          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 px-4 pb-4 sm:pb-0">
            {currentCategory?.subcategories.map((sub) => (
              ...
              >
                ...
                <div className="hidden sm:block absolute bottom-0 left-0 right-0 py-1.5 px-2">
                  <h4 className="font-heading text-white text-xl leading-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] font-light py-[7px] text-center">{sub.name}</h4>
                </div>
              </div>
            ))}
          </div>
