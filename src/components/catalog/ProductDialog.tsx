      ...
      <DialogContent className="max-w-4xl max-h-[90vh] sm:max-h-[85vh] overflow-y-auto p-3 sm:p-6">
        ...
        {selectedProduct && (
          <div className="grid md:grid-cols-[1.2fr,0.8fr] gap-2 md:gap-6">
            <div>
              <div className="relative aspect-square bg-white rounded-lg flex items-center justify-center overflow-hidden border-primary md:border-2 border-0 p-0 mb-2">
