              ...
              >
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 py-1.5 px-2 -mb-px">
                    <h3 className="font-heading text-white text-center sm:text-base leading-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] font-light text-2xl py-[7px]">{category.name}</h3>
                  </div>
                </div>
              </div>
            ))}
